...
<?php ($hook = get_hook('rg_register_pre_pubkey')) ? eval($hook) : null; ?>
				<div class="sf-set set<?php echo ++$forum_page['item_count']; if ($forum_config['o_regs_verify'] == '0') echo ' prepend-top'; ?>">
					<div class="sf-box text required">
...
<?php ($hook = get_hook('rg_register_pre_invite')) ? eval($hook) : null; ?>
				<div class="sf-set set<?php echo ++$forum_page['item_count']; if ($forum_config['o_regs_verify'] == '0') echo ' prepend-top'; ?>">
					<div class="sf-box text required">
						...
						<span class="fld-input"><input type="text" data-suggest-role="invite" id="fld<?php echo $forum_page['fld_count'] ?>" name="req_invite" value="<?php echo(isset($_POST['req_invite']) ? forum_htmlencode($_POST['req_invite']) : '') ?>" size="35" maxlength="99" spellcheck="false" /></span>
					</div>
				</div>
