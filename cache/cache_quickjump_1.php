	...
	<div class="frm-fld frm-select">
		...
		<span class="frm-input"><select id="qjump-select" name="id">
			...
			<optgroup label="Administracja">
				<option value="18"<?php echo ($forum_id == 18) ? ' selected="selected"' : '' ?>>Moderacja i administracja</option>
				<option value="46"<?php echo ($forum_id == 46) ? ' selected="selected"' : '' ?>>Administracja realna.</option>
			</optgroup>
...
(function () {
	...
	sef_friendly_url_array[18] = "moderacja-i-administracja";
	sef_friendly_url_array[46] = "administracja-realna";
